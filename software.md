<!-- Software page: keep software material here rather than on the homepage. -->
<style>
  :root {
    --fx-paper: #FFFCF0;
    --fx-base-50: #F2F0E5;
...
I enjoy crafting tools for statistical computing, research workflows, and experimenting with ideas.
...
Interactive visual and interface experiments are collected in [Maker Space](labs/).
